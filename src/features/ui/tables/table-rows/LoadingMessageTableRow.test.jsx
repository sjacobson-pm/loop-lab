...
import { LoadingMessageTableRow } from './LoadingMessageTableRow';

// **********************************************************************
// * constants

const defaultProps = {
  loadingMessage: faker.lorem.sentence(),
...
const getComponentToRender = (props) => {
  return <LoadingMessageTableRow {...props} />;
};
...
describe('LoadingMessageTableRow', () => {
  // **********************************************************************
  // * setup
  ...
  describe('MessageTableRow', () => {
    it('has correct class name', () => {
      // * ARRANGE
      const expectedClass = `loading-message-table-row ${defaultProps.className}`.trim();

      // * ACT
      render(getComponentToRender(defaultProps));

      // * ASSERT
      const messageTableRow = screen.getByText(defaultProps.loadingMessage);
